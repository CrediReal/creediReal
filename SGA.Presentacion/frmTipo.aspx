<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTipo.aspx.cs" Inherits="SGA.Presentacion.frmTipo" %>
        ...
        <div align="center">
            <cc1:PanelBase ID="PanelBase1" runat="server">
                ...
                <asp:Panel ID="pnlBusqueda" runat="server" CssClass="pnlContenedor">
                    <cc1:GridViewBase ID="grvTipos" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="idTipo" HeaderText="C&#243;digo" ReadOnly="True" />
                            <asp:BoundField DataField="cTipo" HeaderText="Tipo" ReadOnly="True" />
                            <asp:CheckBoxField DataField="lVigente" HeaderText="Vigente" ReadOnly="True" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <cc1:BotonEditar ID="btnEditar" runat="server" CommandArgument='<%# Eval("idTipo") %>'
                ...
                <asp:Panel ID="pnlForm" runat="server" CssClass="pnlContenedor">
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <cc1:LabelBase ID="lblTipo" runat="server" Font-Bold="True" Font-Strikeout="False">Tipo:</cc1:LabelBase>
                            </td>
                            <td style="text-align: left">
                                <cc1:TextBoxBase ID="txtTipo" runat="server" Enabled="False" Font-Bold="True" Height="16px" Width="360px"></cc1:TextBoxBase>
                            </td>
                        </tr>
                        <tr>
