<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmConfiguracion.aspx.cs" Inherits="SGA.Presentacion.frmConfiguracion" %>
        ...
        <div align="center">
            <cc1:PanelBase ID="panelContenido" runat="server">
                ...
                <asp:Panel ID="pnlBusqueda" runat="server" CssClass="pnlContenedor">
                    <cc1:GridViewBase ID="grvConfiguraciones" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="idConfiguracion" HeaderText="C&#243;digo" ReadOnly="True" />
                            <asp:BoundField DataField="cConfiguracion" HeaderText="Configuraci&#243;n" ReadOnly="True" />
                            <asp:CheckBoxField DataField="lVigente" HeaderText="Vigente" ReadOnly="True" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <cc1:BotonEditar ID="btnEditar" runat="server" CommandArgument='<%# Eval("idConfiguracion") %>'
                ...
                <asp:Panel ID="pnlForm" runat="server" CssClass="pnlContenedor">
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <cc1:LabelBase ID="lblConfiguracion" runat="server" Font-Bold="True" Font-Strikeout="False">Configuraci&#243;n:</cc1:LabelBase>
                            </td>
                            <td style="text-align: left">
                                <cc1:TextBoxBase ID="txtConfiguracion" runat="server" Enabled="False" Height="16px" Width="360px" Font-Bold="True"></cc1:TextBoxBase>
                            </td>
                        </tr>
                        <tr>
