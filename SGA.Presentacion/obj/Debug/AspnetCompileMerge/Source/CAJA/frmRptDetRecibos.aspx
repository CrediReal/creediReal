<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmRptDetRecibos.aspx.cs" Inherits="SGA.Presentacion.CAJA.frmRptDetRecibos" %>
    ...
    <div>
        ...
        <tr>
                 ...
                 <td colspan="2">
                     ...
                     <cc1:LabelBase ID="LabelBase2" runat="server">Colaboradores: </cc1:LabelBase>
                     <cc1:ComboBoxUsuario ID="cboColaborador" runat="server" AppendDataBoundItems="True" AutoPostBack="True">
                     </cc1:ComboBoxUsuario>
        ...
        <tr>
                 ...
                 <td colspan="2">
                     ...
                     <cc1:ComboBoxBase ID="cboMoneda" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ComboBoxMoneda1_SelectedIndexChanged">
                     </cc1:ComboBoxBase>
