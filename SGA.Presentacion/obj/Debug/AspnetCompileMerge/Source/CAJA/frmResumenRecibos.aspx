<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmResumenRecibos.aspx.cs" Inherits="SGA.Presentacion.CAJA.frmResumenRecibos" %>
        ...
        <table>
             ...
             <tr>
                 ...
                 <td class="auto-style1">
                     ...
                     <cc1:CalendarioBase ID="CalendarioBase2" runat="server" />
                 </td>
             </tr>

             <tr>
                 <td colspan="2">
                     <cc1:LabelBase ID="LabelBase16" runat="server" style="float: left">Agencias: </cc1:LabelBase>
