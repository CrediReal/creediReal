<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTipoMeta.aspx.cs" Inherits="SGA.Presentacion.frmTipoMeta" %>
        ...
        <div align="center">
            <cc1:panelbase id="panelContenido" runat="server">
                ...
                <asp:Panel ID="pnlBusqueda" runat="server" CssClass="pnlContenedor">
                    <cc1:GridViewBase ID="grvTipoMetas" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="idTipoMeta" HeaderText="C&#243;digo" ReadOnly="True" />
                            <asp:BoundField DataField="cTipoMeta" HeaderText="TipoMeta" ReadOnly="True" />
                            <asp:CheckBoxField DataField="lVigente" HeaderText="Vigente" ReadOnly="True" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <cc1:BotonEditar ID="btnEditar" runat="server" CommandArgument='<%# Eval("idTipoMeta") %>'
                ...
                <asp:Panel ID="pnlForm" runat="server" CssClass="pnlContenedor">
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <cc1:LabelBase ID="lblTipoMeta" runat="server" Font-Bold="True" Font-Strikeout="False">TipoMeta:</cc1:LabelBase>
                            </td>
                            <td style="text-align: left">
                                <cc1:TextBoxBase ID="txtTipoMeta" runat="server" Enabled="False" Height="16px" Width="360px" Font-Bold="True"></cc1:TextBoxBase>
                            </td>
                        </tr>
                        <tr>
