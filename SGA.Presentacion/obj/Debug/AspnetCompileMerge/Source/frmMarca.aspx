<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMarca.aspx.cs" Inherits="SGA.Presentacion.frmMarca" %>
        ...
        <div align="center">
            <cc1:PanelBase ID="panelContenido" runat="server">
                ...
                <asp:Panel ID="pnlBusqueda" runat="server" CssClass="pnlContenedor">
                    <cc1:GridViewBase ID="grvMarcas" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="idMarca" HeaderText="C&#243;digo" ReadOnly="True" />
                            <asp:BoundField DataField="cMarca" HeaderText="Marca" ReadOnly="True" />
                            <asp:CheckBoxField DataField="lVigente" HeaderText="Vigente" ReadOnly="True" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <cc1:BotonEditar ID="btnEditar" runat="server" CommandArgument='<%# Eval("idMarca") %>'
                ...
                <asp:Panel ID="pnlForm" runat="server" CssClass="pnlContenedor">
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <cc1:LabelBase ID="lblMarca" runat="server" Font-Bold="True" Font-Strikeout="False">MARCA:</cc1:LabelBase>
                            </td>
                            <td style="text-align: left">
                                <cc1:TextBoxBase ID="txtMarca" runat="server" Enabled="False" Height="16px" Width="360px" Font-Bold="True"></cc1:TextBoxBase>
                            </td>
                        </tr>
                        <tr>
