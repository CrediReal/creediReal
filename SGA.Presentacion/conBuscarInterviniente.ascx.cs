...
{
    public partial class conBuscarInterviniente : System.Web.UI.UserControl
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (dtDatosCli.Rows.Count > 0)
            {
                if (dtDatosCli.Rows.Count == 1)
                {
                    ...
                    Session["idCliInterv"] = Convert.ToInt32(dtDatosCli.Rows[0]["idCli"]);
                }
                else
                {
        ...
        {
            Session["idCliInterv"] = Convert.ToInt32(lisclientes.SelectedValue);
            GEN.CapaNegocio.clsCNBuscarCli listarCli = new GEN.CapaNegocio.clsCNBuscarCli();
