<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmReporteAgencia.aspx.cs" Inherits="SGA.Presentacion.CAJA.frmReporteAgencia" %>
...
<body>
    ...
    <div align="center">
        <table>
             <tr>
                 <td colspan="4">
                     <cc1:LabelBase ID="LabelBase1" runat="server">Datos Usuario Origen</cc1:LabelBase>
                 </td>
             </tr>
             ...
             <tr>
                 <td colspan="4">
                     <cc1:LabelBase ID="LabelBase9" runat="server" style="float: left">Fecha: </cc1:LabelBase>
                 </td>
             </tr>
