<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmRptRecibos.aspx.cs" Inherits="SGA.Presentacion.CAJA.frmRptRecibos" %>
           ...
           <table>
               ...
               <tr>
                 <td colspan="4" style="text-align: left">
                     ...
                     <cc1:LabelBase ID="LabelBase7" runat="server" style="text-align: left">Fecha: </cc1:LabelBase>
                     <cc1:CalendarioBase ID="dtpFechaRpt" runat="server" style="text-align: left" />
