...
{
    public partial class frmDepositoCuentaAhorro : System.Web.UI.Page
    {
        ...
        private void RegistrarCuenta()
        {
            ...
            int idCuenta = Convert.ToInt32(txtNumeroCuenta.Text);            
            double montoDeposito = Convert.ToDouble(txtMonto.Text);
            string DNIDdepositante = txtDNIDepositante.Text;
