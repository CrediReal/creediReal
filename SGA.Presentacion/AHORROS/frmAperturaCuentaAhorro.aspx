<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAperturaCuentaAhorro.aspx.cs" Inherits="SGA.Presentacion.AHORROS.frmAperturaCuentaAhorro" %>
...
<body>
    <form id="form1" runat="server">
        <table>
            ...
            <tr>
                <td>
                    <cc1:LabelBase ID="lbTipoCuenta" Text="Tipo de Cuenta" runat="server"></cc1:LabelBase>
                    </td>
                <td>
                    <cc1:ComboBoxBase ID="cbTipoCuenta" runat="server">
                        <asp:ListItem Value="1">Plazo Fijo</asp:ListItem>
                        <asp:ListItem Value="2">Ahorro Libre</asp:ListItem>
                    </cc1:ComboBoxBase>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                    <cc1:LabelBase ID="LabelBase1" Text="Monto" runat="server"></cc1:LabelBase>
                </td>
                <td class="auto-style2">
            ...
            <tr>
                <td class="auto-style2">
                    <cc1:LabelBase ID="LabelBase2" Text="Plazo en días" runat="server"></cc1:LabelBase>
                </td>
                <td class="auto-style2">
                    <cc1:TextBoxBase ID="txtPlazo" runat="server"></cc1:TextBoxBase>
                </td>
            </tr>
            <tr>
                <td>
