<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="conBuscarInterviniente.ascx.cs" Inherits="SGA.Presentacion.conBuscarInterviniente" %>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList CssClass="lblBase" ID="rblTipoBusqueda" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblTipoBusqueda_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="1" Selected="True">Documento</asp:ListItem>
            ...
            <tr>
                <td align="center">
                    <cc1:ListBoxBase ID="lisclientes" runat="server" 
                        ...
                        Visible="true" AutoPostBack="True"></cc1:ListBoxBase>
                </td>
            </tr>
